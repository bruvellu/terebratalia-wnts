...
#title: Expression of Wnt signaling components suggests that ligand-receptor context plays a role in the patterning of brachiopod body regions
...
The Wnt signaling pathways play a great variety of roles during animal
embryogenesis.

However, it is less studied in the spiralians.

Here, we characterize the Wnt complement and developmental expression of Wnt
pathway components in the brachiopod *Terebratalia transversa*.

We identify every Wnt subfamily in *T. transversa*.

Wnt ligands, receptors and inhibitors are expressed in partially overlapping
domains along the AP axis forming subregions of unique transcriptional
landscape that correlate with the body regions of the larva.

The general pattern of expression in the brachiopod shows similarities to other
spiralians and deuterostomes.

The receptors are expressed in broad anterior domains, while the ligands are
expressed in bands of expression, except in the anterior region.

The combinatorial expression reveals a series of microregions of unique
transcriptional landscape along the anteroposterior axis during gastrulation.

The expression of Wnt signaling components in *T. transversa* suggests the
pathway plays diverse roles in the specification, differentiation and
morphogenesis of the different larval body regions in brachiopods similar to
other bilaterians.

The expression of Wnt signaling components in *T. transversa* suggests the
ligand-receptor context might play a role in the specification and
morphogenesis of the brachiopod larval body regions.
...
Wnt signaling pathway plays a major role in animal development. The ligands are
secreted glycoproteins and receptors are transmembrane proteins. Early role in
AV patterning and a later role in AP patterning. Some Wnt ligands are
contiguous in the genome. Expression in spiralians is still understudied.
Brachiopod preliminary genome, transcriptome and in situ expression data.
