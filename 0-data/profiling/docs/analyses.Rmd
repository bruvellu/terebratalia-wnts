...
pol_hmp <- plot_heatmap(pol_data, heat_annot, blues, breaks = seq(from = 4, to = 18, length.out = 256))
...
# Plot wnt heatmap
pol_hmp_mean <- plot_heatmap(pol_mean, annot_mean, blues, rowgaps = c(5), breaks = seq(from = 5, to = 14, length.out = 256))
